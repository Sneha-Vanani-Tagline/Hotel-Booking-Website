...
from app.models import User_cred, Hotels, Bookings, Rooms, Audit_logs
from .views import UserView, BookingView, RoomView, HotelView, AuditLogView
...
def init_admin():
    ...
    flaskAdmin.add_view(AuditLogView(Audit_logs, db))